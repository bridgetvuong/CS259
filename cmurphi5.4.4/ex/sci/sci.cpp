/******************************
  Program "sci.m" compiled by "Caching Murphi Release 5.4.4"

  Murphi Last Compiled date: "Jan 21 2013"
 ******************************/
...
#define MURPHI_DATE "Jan 21 2013"
#define PROTOCOL_NAME "sci"
#define BITS_IN_WORLD 437
#define HASHC
...
class mu_1_ProcId: public mu__byte
{
 public:
  ...
  mu_1_ProcId (const char *name, int os): mu__byte(1, 3, 2, name, os) {};
  mu_1_ProcId (void): mu__byte(1, 3, 2) {};
  mu_1_ProcId (int val): mu__byte(1, 3, 2, "Parameter or function result.", 0)
    { operator=(val); };
...
const char *mu_1_ProcId::values[] =
  { "ProcId_1","ProcId_2","ProcId_3",NULL };
...
class mu_1_MemoryId: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_MemoryId& val)
    {
      if (val.defined())
	return ( s << mu_1_MemoryId::values[ int(val) - 4 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_MemoryId (const char *name, int os): mu__byte(4, 4, 1, name, os) {};
  mu_1_MemoryId (void): mu__byte(4, 4, 1) {};
  mu_1_MemoryId (int val): mu__byte(4, 4, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_NodeId: public mu__byte
{
 public:
  ...
  mu_1_NodeId (const char *name, int os): mu__byte(0, 3, 3, name, os) {};
  mu_1_NodeId (void): mu__byte(0, 3, 3) {};
  mu_1_NodeId (int val): mu__byte(0, 3, 3, "Parameter or function result.", 0)
    { operator=(val); };
  int value() const
  {
  ...
  inline int value(int val)
  {
    ...
    if ((val >= 1) && (val <= 3)) return (mu__byte::value(val-1)+1);
...
const char *mu_1_NodeId::values[] = {"ProcId_1","ProcId_2","ProcId_3","MemoryId_1",NULL };
...
class mu_1_MemoryLineId: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_MemoryLineId& val)
    {
      if (val.defined())
	return ( s << mu_1_MemoryLineId::values[ int(val) - 5 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_MemoryLineId (const char *name, int os): mu__byte(5, 5, 1, name, os) {};
  mu_1_MemoryLineId (void): mu__byte(5, 5, 1) {};
  mu_1_MemoryLineId (int val): mu__byte(5, 5, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_CacheLineId: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_CacheLineId& val)
    {
      if (val.defined())
	return ( s << mu_1_CacheLineId::values[ int(val) - 6 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_CacheLineId (const char *name, int os): mu__byte(6, 6, 1, name, os) {};
  mu_1_CacheLineId (void): mu__byte(6, 6, 1) {};
  mu_1_CacheLineId (int val): mu__byte(6, 6, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_Data: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_Data& val)
    {
      if (val.defined())
	return ( s << mu_1_Data::values[ int(val) - 7 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_Data (const char *name, int os): mu__byte(7, 7, 1, name, os) {};
  mu_1_Data (void): mu__byte(7, 7, 1) {};
  mu_1_Data (int val): mu__byte(7, 7, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_AccessCommandsReq: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_AccessCommandsReq::values[ int(val) - 8] );
    else return ( s << "Undefined" );
  };

  mu_1_AccessCommandsReq (const char *name, int os): mu__byte(8, 10, 2, name, os) {};
  mu_1_AccessCommandsReq (void): mu__byte(8, 10, 2) {};
  mu_1_AccessCommandsReq (int val): mu__byte(8, 10, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_AccessCommandsRes: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_AccessCommandsRes::values[ int(val) - 11] );
    else return ( s << "Undefined" );
  };

  mu_1_AccessCommandsRes (const char *name, int os): mu__byte(11, 12, 2, name, os) {};
  mu_1_AccessCommandsRes (void): mu__byte(11, 12, 2) {};
  mu_1_AccessCommandsRes (int val): mu__byte(11, 12, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_MemoryCacheCommands: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_MemoryCacheCommands::values[ int(val) - 13] );
    else return ( s << "Undefined" );
  };

  mu_1_MemoryCacheCommands (const char *name, int os): mu__byte(13, 71, 6, name, os) {};
  mu_1_MemoryCacheCommands (void): mu__byte(13, 71, 6) {};
  mu_1_MemoryCacheCommands (int val): mu__byte(13, 71, 6, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_SStatValues: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_SStatValues::values[ int(val) - 72] );
    else return ( s << "Undefined" );
  };

  mu_1_SStatValues (const char *name, int os): mu__byte(72, 79, 4, name, os) {};
  mu_1_SStatValues (void): mu__byte(72, 79, 4) {};
  mu_1_SStatValues (int val): mu__byte(72, 79, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_MemoryCacheStates: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_MemoryCacheStates::values[ int(val) - 80] );
    else return ( s << "Undefined" );
  };

  mu_1_MemoryCacheStates (const char *name, int os): mu__byte(80, 229, 8, name, os) {};
  mu_1_MemoryCacheStates (void): mu__byte(80, 229, 8) {};
  mu_1_MemoryCacheStates (int val): mu__byte(80, 229, 8, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -80]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_DataFlags: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_DataFlags::values[ int(val) - 230] );
    else return ( s << "Undefined" );
  };

  mu_1_DataFlags (const char *name, int os): mu__byte(230, 240, 4, name, os) {};
  mu_1_DataFlags (void): mu__byte(230, 240, 4) {};
  mu_1_DataFlags (int val): mu__byte(230, 240, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -230]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_AccessTypes: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_AccessTypes::values[ int(val) - 241] );
    else return ( s << "Undefined" );
  };

  mu_1_AccessTypes (const char *name, int os): mu__byte(241, 256, 5, name, os) {};
  mu_1_AccessTypes (void): mu__byte(241, 256, 5) {};
  mu_1_AccessTypes (int val): mu__byte(241, 256, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -241]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_FetchOptions: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_FetchOptions::values[ int(val) - 257] );
    else return ( s << "Undefined" );
  };

  mu_1_FetchOptions (const char *name, int os): mu__long(257, 259, 2, name, os) {};
  mu_1_FetchOptions (void): mu__long(257, 259, 2) {};
  mu_1_FetchOptions (int val): mu__long(257, 259, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -257]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_TransactStatus: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_TransactStatus::values[ int(val) - 260] );
    else return ( s << "Undefined" );
  };

  mu_1_TransactStatus (const char *name, int os): mu__long(260, 280, 5, name, os) {};
  mu_1_TransactStatus (void): mu__long(260, 280, 5) {};
  mu_1_TransactStatus (int val): mu__long(260, 280, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -260]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_FindFlags: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_FindFlags::values[ int(val) - 281] );
    else return ( s << "Undefined" );
  };

  mu_1_FindFlags (const char *name, int os): mu__long(281, 287, 3, name, os) {};
  mu_1_FindFlags (void): mu__long(281, 287, 3) {};
  mu_1_FindFlags (int val): mu__long(281, 287, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -281]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_BypassOptions: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_BypassOptions::values[ int(val) - 288] );
    else return ( s << "Undefined" );
  };

  mu_1_BypassOptions (const char *name, int os): mu__long(288, 290, 2, name, os) {};
  mu_1_BypassOptions (void): mu__long(288, 290, 2) {};
  mu_1_BypassOptions (int val): mu__long(288, 290, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -288]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_StableGroups: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_StableGroups::values[ int(val) - 291] );
    else return ( s << "Undefined" );
  };

  mu_1_StableGroups (const char *name, int os): mu__long(291, 295, 3, name, os) {};
  mu_1_StableGroups (void): mu__long(291, 295, 3) {};
  mu_1_StableGroups (int val): mu__long(291, 295, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -291]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
void mu_1_ReqPacket::set_self(const char *n, int os)
{
  ...
  if (name) mu_cmd.set_self_2(name, ".cmd", os + 3 ); else mu_cmd.set_self_2(NULL, NULL, 0);
  if (name) mu_sourceId.set_self_2(name, ".sourceId", os + 5 ); else mu_sourceId.set_self_2(NULL, NULL, 0);
  if (name) mu_offset.set_self_2(name, ".offset", os + 8 ); else mu_offset.set_self_2(NULL, NULL, 0);
  if (name) mu_mopCop.set_self_2(name, ".mopCop", os + 9 ); else mu_mopCop.set_self_2(NULL, NULL, 0);
  if (name) mu_s.set_self_2(name, ".s", os + 15 ); else mu_s.set_self_2(NULL, NULL, 0);
  if (name) mu_eh.set_self_2(name, ".eh", os + 17 ); else mu_eh.set_self_2(NULL, NULL, 0);
  if (name) mu_data.set_self_2(name, ".data", os + 19 ); else mu_data.set_self_2(NULL, NULL, 0);
  if (name) mu_newId.set_self_2(name, ".newId", os + 20 ); else mu_newId.set_self_2(NULL, NULL, 0);
  if (name) mu_memId.set_self_2(name, ".memId", os + 23 ); else mu_memId.set_self_2(NULL, NULL, 0);
}
...
void mu_1_ResPacket::set_self(const char *n, int os)
{
  ...
  if (name) mu_backId.set_self_2(name, ".backId", os + 18 ); else mu_backId.set_self_2(NULL, NULL, 0);
}
...
void mu_1_MemoryLine::set_self(const char *n, int os)
{
  ...
  if (name) mu_data.set_self_2(name, ".data", os + 11 ); else mu_data.set_self_2(NULL, NULL, 0);
}
 ...
 public:
  ...
  mu_1_MemoryLine& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: MemoryLineId is internally represented from 5 to 5.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 5 ];
...
if (n) array[i].set_self_ar(n,"MemoryLineId_1", i * 12 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
void mu_1_CacheLine::set_self(const char *n, int os)
{
  ...
  if (name) mu_cState.set_self_2(name, ".cState", os + 0 ); else mu_cState.set_self_2(NULL, NULL, 0);
  if (name) mu_forwId.set_self_2(name, ".forwId", os + 8 ); else mu_forwId.set_self_2(NULL, NULL, 0);
  if (name) mu_backId.set_self_2(name, ".backId", os + 11 ); else mu_backId.set_self_2(NULL, NULL, 0);
  if (name) mu_memId.set_self_2(name, ".memId", os + 14 ); else mu_memId.set_self_2(NULL, NULL, 0);
  if (name) mu_addrOffset.set_self_2(name, ".addrOffset", os + 17 ); else mu_addrOffset.set_self_2(NULL, NULL, 0);
  if (name) mu_data.set_self_2(name, ".data", os + 18 ); else mu_data.set_self_2(NULL, NULL, 0);
}
 ...
 public:
  ...
  mu_1_CacheLine& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: CacheLineId is internally represented from 6 to 6.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 6 ];
...
if (n) array[i].set_self_ar(n,"CacheLineId_1", i * 19 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1_InstructionType: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_InstructionType::values[ int(val) - 296] );
    else return ( s << "Undefined" );
  };

  mu_1_InstructionType (const char *name, int os): mu__long(296, 301, 3, name, os) {};
  mu_1_InstructionType (void): mu__long(296, 301, 3) {};
  mu_1_InstructionType (int val): mu__long(296, 301, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -296]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_InstructionPhase: public mu__long
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_InstructionPhase::values[ int(val) - 302] );
    else return ( s << "Undefined" );
  };

  mu_1_InstructionPhase (const char *name, int os): mu__long(302, 305, 3, name, os) {};
  mu_1_InstructionPhase (void): mu__long(302, 305, 3) {};
  mu_1_InstructionPhase (int val): mu__long(302, 305, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  const char * Name() { return values[ value() -302]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
void mu_1_ExecUnit::set_self(const char *n, int os)
{
  ...
  if (name) mu_resPacket.set_self_2(name, ".resPacket", os + 101 ); else mu_resPacket.set_self_2(NULL, NULL, 0);
}
...
void mu_1_Proc::set_self(const char *n, int os)
{
  ...
  if (name) mu_cache.set_self_2(name, ".cache", os + 122 ); else mu_cache.set_self_2(NULL, NULL, 0);
}
 ...
 public:
  ...
  mu_1_Proc& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: ProcId is internally represented from 3 to 1.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 1 ];
...
if (n) array[i].set_self_ar(n,"ProcId_1", i * 141 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"ProcId_2", i * 141 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"ProcId_3", i * 141 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
 ...
 public:
  ...
  mu_1_Memory& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: MemoryId is internally represented from 4 to 4.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 4 ];
...
if (n) array[i].set_self_ar(n,"MemoryId_1", i * 12 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
const int mu_ProcId_3 = 3;
const int mu_MemoryId_1 = 4;
const int mu_MemoryLineId_1 = 5;
const int mu_CacheLineId_1 = 6;
const int mu_Data_1 = 7;
const int mu_SC_MREAD = 8;
const int mu_SC_MWRITE64 = 9;
const int mu_SC_CREAD = 10;
const int mu_SC_RESP00 = 11;
const int mu_SC_RESP64 = 12;
const int mu_MC_PASS_HEAD = 13;
const int mu_MC_CACHE_FRESH = 14;
const int mu_MC_CACHE_CLEAN = 15;
const int mu_MC_CACHE_DIRTY = 16;
const int mu_MC_LOCK_CLEAR = 17;
const int mu_MC_LOCK_SET = 18;
const int mu_MC_ATTACH_TO_GONE = 19;
const int mu_MC_ATTACH_TO_LIST = 20;
const int mu_MC_LIST_TO_GONE = 21;
const int mu_MC_FRESH_TO_HOME = 22;
const int mu_MC_LIST_TO_HOME = 23;
const int mu_MC_LIST_TO_FRESH = 24;
const int mu_MC_WASH_TO_FRESH = 25;
const int mu_CC_LOCK_CLEAR = 26;
const int mu_CC_PEND_VALID = 27;
const int mu_CC_FRESH_INVALID = 28;
const int mu_CC_NEXT_SSAVE = 29;
const int mu_CC_PREV_VMID = 30;
const int mu_CC_PREV_VTAIL = 31;
const int mu_CC_VALID_INVALID = 32;
const int mu_CC_TAIL_INVALID = 33;
const int mu_CC_NEXT_VMID = 34;
const int mu_CC_NEXT_FHEAD = 35;
const int mu_CC_NEXT_CHEAD = 36;
const int mu_CC_NEXT_DHEAD = 37;
const int mu_CC_HEADD_TO_STALE = 38;
const int mu_CC_HEADV_TO_STALE = 39;
const int mu_CC_TAILD_TO_STALE = 40;
const int mu_CC_TAILV_TO_STALE = 41;
const int mu_CC_PREV_IMID = 42;
const int mu_CC_PREV_DTAIL = 43;
const int mu_CC_PREV_STAIL = 44;
const int mu_CC_PREV_ITAIL = 45;
const int mu_CC_NEXT_IMID = 46;
const int mu_CC_NEXT_VHEAD = 47;
const int mu_CC_NEXT_SHEAD = 48;
const int mu_CC_NEXT_IHEAD = 49;
const int mu_CC_LOCK_SET = 50;
const int mu_CC_COPY_VALID = 51;
const int mu_CC_COPY_STALE = 52;
const int mu_CC_COPY_QOLB = 53;
const int mu_CC_HEADE_TO_DIRTY = 54;
const int mu_CC_TAILE_TO_DIRTY = 55;
const int mu_CC_HEADE_TO_STALE0 = 56;
const int mu_CC_HEADE_TO_STALE1 = 57;
const int mu_CC_TAILE_TO_STALE0 = 58;
const int mu_CC_TAILE_TO_STALE1 = 59;
const int mu_CC_HEADU_TO_NEED0 = 60;
const int mu_CC_HEADU_TO_NEED1 = 61;
const int mu_CC_TAILU_TO_NEED0 = 62;
const int mu_CC_TAILU_TO_NEED1 = 63;
const int mu_CC_NEXT_EHEAD = 64;
const int mu_CC_NEXT_NHEAD = 65;
const int mu_CC_PREV_ETAIL = 66;
const int mu_CC_PREV_NTAIL = 67;
const int mu_CC_PREVI_TO_USED = 68;
const int mu_CC_PREVI_TO_NEED = 69;
const int mu_CC_TAILI_TO_USED = 70;
const int mu_CC_TAILI_TO_NEED = 71;
const int mu_RESP_NORMAL = 72;
const int mu_RESP_ADVICE = 73;
const int mu_RESP_GONE = 74;
const int mu_RESP_LOCKED = 75;
const int mu_RESP_CONFLICT = 76;
const int mu_RESP_DATA = 77;
const int mu_RESP_TYPE = 78;
const int mu_RESP_ADDRESS = 79;
const int mu_MS_HOME = 80;
const int mu_MS_FRESH = 81;
const int mu_MS_GONE = 82;
const int mu_MS_WASH = 83;
const int mu_CS_INVALID = 84;
const int mu_CS_OD_RETN_IN = 85;
const int mu_CS_OD_spin_IN = 86;
const int mu_CS_QUEUED_FRESH = 87;
const int mu_CS_ONLY_DIRTY = 88;
const int mu_CS_QUEUED_DIRTY = 89;
const int mu_CS_HEAD_DIRTY = 90;
const int mu_CS_QUEUED_CLEAN = 91;
const int mu_CS_QUEUED_MODS = 92;
const int mu_CS_PENDING = 93;
const int mu_CS_QUEUED_JUNK = 94;
const int mu_CS_MV_forw_MV = 95;
const int mu_CS_MV_back_IN = 96;
const int mu_CS_MID_VALID = 97;
const int mu_CS_MID_COPY = 98;
const int mu_CS_ONLYQ_DIRTY = 99;
const int mu_CS_HD_INVAL_OD = 100;
const int mu_CS_MI_forw_MI = 101;
const int mu_CS_MI_back_IN = 102;
const int mu_CS_HEAD_IDLE = 103;
const int mu_CS_MID_IDLE = 104;
const int mu_CS_TAIL_VALID = 105;
const int mu_CS_TAIL_COPY = 106;
const int mu_CS_OF_retn_IN = 107;
const int mu_CS_QUEUED_HOME = 108;
const int mu_CS_HX_FORW_HX = 109;
const int mu_CS_HX_FORW_OX = 110;
const int mu_CS_ONLY_FRESH = 111;
const int mu_CS_OF_MODS_OD = 112;
const int mu_CS_HX_INVAL_OX = 113;
const int mu_CS_HEAD_FRESH = 114;
const int mu_CS_HF_MODS_HD = 115;
const int mu_CS_TO_INVALID = 116;
const int mu_CS_TV_back_IN = 117;
const int mu_CS_QF_FLUSH_IN = 118;
const int mu_CS_LOCAL_CLEAN = 119;
const int mu_CS_HW_WASH_HF = 120;
const int mu_CS_ONLYP_DIRTY = 121;
const int mu_CS_HEAD_STALE0 = 122;
const int mu_CS_HEAD_STALE1 = 123;
const int mu_CS_HX_retn_IN = 124;
const int mu_CS_HEAD_VALID = 125;
const int mu_CS_LOCAL_DIRTY = 126;
const int mu_CS_H0_PEND_HX = 127;
const int mu_CS_H1_PEND_HX = 128;
const int mu_CS_HX_PEND_HX = 129;
const int mu_CS_OC_retn_IN = 130;
const int mu_CS_HEAD_CLEAN = 131;
const int mu_CS_ONLY_CLEAN = 132;
const int mu_CS_HX_XXXX_OD = 133;
const int mu_CS_TS0_Move_TE = 134;
const int mu_CS_TS1_Move_TE = 135;
const int mu_CS_TS_copy_TV = 136;
const int mu_CS_TV_mark_TS = 137;
const int mu_CS_HEAD_WASH = 138;
const int mu_CS_TX_XXXX_OD = 139;
const int mu_CS_TV_mark_TE = 140;
const int mu_CS_TD_back_IN = 141;
const int mu_CS_TS_back_IN = 142;
const int mu_CS_TE_back_IN = 143;
const int mu_CS_TAIL_DIRTY = 144;
const int mu_CS_TAIL_EXCL = 145;
const int mu_CS_TD_mark_TE = 146;
const int mu_CS_TAIL_IDLE = 147;
const int mu_CS_TI_back_IN = 148;
const int mu_CS_TAIL_STALE0 = 149;
const int mu_CS_TAIL_STALE1 = 150;
const int mu_CS_HV_MARK_HE = 151;
const int mu_CS_HEAD_EXCL = 152;
const int mu_CS_HD_MARK_HE = 153;
const int mu_CS_TN_back_IN = 154;
const int mu_CS_TN_send_TS = 155;
const int mu_CS_TN_send_TI = 156;
const int mu_CS_OD_CLEAN_OC = 157;
const int mu_CS_ONLY_USED = 158;
const int mu_CS_TAIL_NEED = 159;
const int mu_CS_HS0_MOVE_HE = 160;
const int mu_CS_HS1_MOVE_HE = 161;
const int mu_CS_HS_COPY_HV = 162;
const int mu_CS_HV_MARK_HS = 163;
const int mu_CS_HD_CLEAN_HC = 164;
const int mu_CS_HEAD_NEED = 165;
const int mu_CS_SAVE_STALE = 166;
const int mu_CS_SS_next_IN = 167;
const int mu_CS_HN_SEND_HS = 168;
const int mu_CS_HN_SEND_HI = 169;
const int mu_CS_HD_WASH_HF = 170;
const int mu_CS_TAIL_USED = 171;
const int mu_CS_HS0_MOVE_HI = 172;
const int mu_CS_HS1_MOVE_HI = 173;
const int mu_CS_TS0_Move_TI = 174;
const int mu_CS_TS1_Move_TI = 175;
const int mu_CS_HEAD_USED = 176;
const int mu_CI_HEAD_DIRTY = 177;
const int mu_CI_HEAD_CLEAN = 178;
const int mu_CI_HEAD_WASH = 179;
const int mu_CI_HEAD_MODS = 180;
const int mu_CI_HEADQ_DIRTY = 181;
const int mu_CI_HEADQ_EXCL = 182;
const int mu_CI_HD_WASH_HF = 183;
const int mu_CI_HW_WASH_HF = 184;
const int mu_CI_QUEUED_CLEAN = 185;
const int mu_CI_QUEUED_FRESH = 186;
const int mu_CI_QUEUED_DIRTY = 187;
const int mu_CI_ONLY_EXCL = 188;
const int mu_CI_HEAD_EXCL = 189;
const int mu_CI_TAIL_EXCL = 190;
const int mu_CI_QD_MODS_OU = 191;
const int mu_CI_HD_MODS_OU = 192;
const int mu_CI_HD_FLUSH_IN = 193;
const int mu_CI_HC_FLUSH_IN = 194;
const int mu_CI_LD_FLUSH_IN = 195;
const int mu_CI_OD_PURGE_IN = 196;
const int mu_CI_HN_PURGE_IN = 197;
const int mu_CI_HE_PURGE_IN = 198;
const int mu_CI_HD_PURGE_IN = 199;
const int mu_CI_LD_CLEAN_LC = 200;
const int mu_CI_OD_CLEAN_OC = 201;
const int mu_CI_HD_CLEAN_HC = 202;
const int mu_CI_HN_CLEAN_OC = 203;
const int mu_CI_HE_CLEAN_OC = 204;
const int mu_CI_HD_MODS_HE = 205;
const int mu_CI_HD_MODS_HU = 206;
const int mu_CI_TD_MODS_TE = 207;
const int mu_CI_TD_MODS_TU = 208;
const int mu_CI_HN_DEQOLB_HS = 209;
const int mu_CI_TN_DEQOLB_TS = 210;
const int mu_CI_HN_REQOLB_HI = 211;
const int mu_CI_TN_REQOLB_TI = 212;
const int mu_CI_HI_DELETE_IN = 213;
const int mu_CI_MI_DELETE_IN = 214;
const int mu_CI_TI_DELETE_IN = 215;
const int mu_CI_CHECK_HOME = 216;
const int mu_CI_HF_FLUSH_IN = 217;
const int mu_CI_QF_FLUSH_IN = 218;
const int mu_CI_QD_FLUSH_IN = 219;
const int mu_CI_OD_FLUSH_IN = 220;
const int mu_CI_OC_FLUSH_IN = 221;
const int mu_CI_OF_FLUSH_IN = 222;
const int mu_CI_HN_FLUSH_IN = 223;
const int mu_CI_HE_FLUSH_IN = 224;
const int mu_CI_WRITE_CHECK = 225;
const int mu_CI_WC_DONE_IN = 226;
const int mu_CI_READ_FRESH = 227;
const int mu_CI_ONLY_CLEAN = 228;
const int mu_CI_ONLY_DIRTY = 229;
const int mu_NORM_NONE = 230;
const int mu_NORM_DATA = 231;
const int mu_NORM_NULL = 232;
const int mu_NORM_SKIP = 233;
const int mu_FULL_NONE = 234;
const int mu_FULL_DATA = 235;
const int mu_FULL_NULL = 236;
const int mu_HUGE_TAGS = 237;
const int mu_LOCK_DATA = 238;
const int mu_MISS_MORE = 239;
const int mu_MISS_NONE = 240;
const int mu_CT_ONLY_DIRTY = 241;
const int mu_CT_HEAD_DIRTY = 242;
const int mu_CT_MID_VALID = 243;
const int mu_CT_HEAD_IDLE = 244;
const int mu_CT_ONLY_FRESH = 245;
const int mu_CT_HEAD_FRESH = 246;
const int mu_CT_ONLYP_DIRTY = 247;
const int mu_CT_HEAD_RETN = 248;
const int mu_CT_HEAD_CLEAN = 249;
const int mu_CT_HEAD_WASH = 250;
const int mu_CT_TAIL_EXCL = 251;
const int mu_CT_HEAD_EXCL = 252;
const int mu_CT_ONLY_USED = 253;
const int mu_CT_HEAD_NEED = 254;
const int mu_CT_TAIL_USED = 255;
const int mu_CT_HEAD_USED = 256;
const int mu_CO_FETCH = 257;
const int mu_CO_LOAD = 258;
const int mu_CO_STORE = 259;
const int mu_TS_NORM_NULL = 260;
const int mu_TS_NORM_CODE = 261;
const int mu_TS_RESP_FAKE = 262;
const int mu_TS_RESP_CODE = 263;
const int mu_TS_CORE_JUNK = 264;
const int mu_TS_RESP_SIZE = 265;
const int mu_TS_RESP_DIFF = 266;
const int mu_TS_LINK_DEAD = 267;
const int mu_TS_LOST_TIDS = 268;
const int mu_TS_TIME_TIDS = 269;
const int mu_TS_SEND_TYPE = 270;
const int mu_TS_SEND_ADDR = 271;
const int mu_TS_TIME_BUSY = 272;
const int mu_TS_TIME_RESP = 273;
const int mu_TS_RESP_IDS = 274;
const int mu_TS_RESP_BAD = 275;
const int mu_TS_LOCK_BEFORE = 276;
const int mu_TS_LOCK_DURING = 277;
const int mu_TS_MTAG_STATE = 278;
const int mu_TS_CTAG_STATE = 279;
const int mu_TS_CODE_NULL = 280;
const int mu_FF_FIND = 281;
const int mu_FF_WAIT = 282;
const int mu_FF_LOAD = 283;
const int mu_FF_STORE = 284;
const int mu_FF_LOCK = 285;
const int mu_FF_ENQOLB = 286;
const int mu_FF_INDEX = 287;
const int mu_CU_BYPASS = 288;
const int mu_CU_LOCAL = 289;
const int mu_CU_GLOBAL = 290;
const int mu_SG_NONE = 291;
const int mu_SG_INVALID = 292;
const int mu_SG_STALE = 293;
const int mu_SG_GLOBAL = 294;
const int mu_SG_LOCAL = 295;
const int mu_I_NONE = 296;
const int mu_I_LOAD = 297;
const int mu_I_STORE = 298;
const int mu_I_FLUSH = 299;
const int mu_I_DELETE = 300;
const int mu_I_LOCK = 301;
const int mu_I_START = 302;
const int mu_I_ALLOCATE = 303;
const int mu_I_SETUP = 304;
const int mu_I_CLEANUP = 305;
...
/*** Variable declaration ***/
mu_1__type_3 mu_memory("memory",425);
...
/*** Variable declaration ***/
mu_1_MemoryCacheStates mu_temp("temp",11);
...
bool mu__boolexpr146;
  ...
  mu__boolexpr146 = ((mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId>=1 && mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId<=3)) ; 
}
...
bool mu__boolexpr155;
  ...
  mu__boolexpr155 = ((mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId>=1 && mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId<=3)) ; 
}
...
/*** Variable declaration ***/
mu_1_CacheLineId mu_c("c",21);

/*** Variable declaration ***/
mu_1_DataFlags mu_updates("updates",22);
...
bool mu__boolexpr165;
  ...
  mu__boolexpr165 = ((mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId>=4 && mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId<=4)) ; 
}
...
bool mu__boolexpr167;
  ...
  mu__boolexpr167 = ((mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId>=4 && mu_proc[mu_j].mu_exec.mu_reqPacket.mu_targetId<=4)) ; 
}
...
/*** Variable declaration ***/
mu_1_DataFlags mu_updates("updates",21);

/*** Variable declaration ***/
mu_1_SStatValues mu_status("status",25);
...
bool Condition(unsigned r)
{
  ...
  if (r>=21 && r<=29) return R5.Condition(r-21);
  if (r>=30 && r<=32) return R6.Condition(r-30);
...
void Code(unsigned r)
{
  ...
  if (r>=21 && r<=29) { R5.Code(r-21); return; } 
  if (r>=30 && r<=32) { R6.Code(r-30); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=21 && r<=29) { return R5.Priority(); } 
  if (r>=30 && r<=32) { return R6.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=21 && r<=29) return R5.Name(r-21);
  if (r>=30 && r<=32) return R6.Name(r-30);
  return NULL;
}
};
const unsigned numrules = 33;
...
: Presentation(Simple)
{
  ...
  ********************/
  in = new bool[6];
 in_mu_1_ProcId = new int[6];
 perm_mu_1_ProcId = new arr_mu_1_ProcId[6];
 revperm_mu_1_ProcId = new arr_mu_1_ProcId[6];
    ...
    for (i=0; i<6; i++)
      ...
      i_mu_1_ProcId += carry;
      if (i_mu_1_ProcId >= 6) { i_mu_1_ProcId = 0; carry = 1; } 
      else { carry = 0; } 
    }
  }
  else
...
void PermSet::SimpleToExplicit()
{
  ...
  int start_mu_1_ProcId[3];
  int size_mu_1_ProcId[3];
  bool should_be_in_mu_1_ProcId[6];
...
void mu_1__type_2::ArrayLimit(PermSet& Perm)
{
  ...
  int compare;
  static mu_1_Proc value[3];
  // limit
  bool exists;
  bool split;
  bool goodset_mu_1_ProcId[3];
  bool pos_mu_1_ProcId[3][3];
  // sorting mu_1_ProcId
...
void mu_1__type_2::Limit(PermSet& Perm)
{
  ...
  // only if there is more than 1 permutation in class
  if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
    {
      exists = FALSE;
      split = FALSE;
  ...
  while_guard = FALSE;
  while_guard = while_guard || (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3);
  while ( while_guard )
    {
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_reqPacket.mu_targetId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_reqPacket.mu_targetId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_reqPacket.mu_sourceId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_reqPacket.mu_sourceId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_reqPacket.mu_newId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_reqPacket.mu_newId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_reqPacket.mu_memId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_reqPacket.mu_memId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_resPacket.mu_forwId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_resPacket.mu_forwId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_exec.mu_resPacket.mu_backId.isundefined()
                ...
                &&(*this)[k+1].mu_exec.mu_resPacket.mu_backId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_forwId.isundefined()
                ...
                &&(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_forwId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_backId.isundefined()
                ...
                &&(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_backId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      if (Perm.MTO_class_mu_1_ProcId() && count_mu_1_ProcId<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_memId.isundefined()
                ...
                &&(*this)[k+1].mu_cache.mu_line[mu_CacheLineId_1].mu_memId<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_ProcId; i++) // for value priority
      ...
      while_guard = FALSE;
      while_guard = while_guard || count_mu_1_ProcId<3;
