/******************************
  Program "scierr.m" compiled by "Caching Murphi Release 5.4.4"
...
#define PROTOCOL_NAME "scierr"
#define BITS_IN_WORLD 968
#define ALIGN
#define HASHC
...
class mu_1_AccessTypes: public mu__long
{
 public:
  inline int operator=(int val) { return value(val); };
  ...
  mu_1_AccessTypes (const char *name, int os): mu__long(240, 255, 5, name, os) {};
  mu_1_AccessTypes (void): mu__long(240, 255, 5) {};
  mu_1_AccessTypes (int val): mu__long(240, 255, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
void mu_1_ReqPacket::set_self(const char *n, int os)
{
  ...
  if (name) mu_cmd.set_self_2(name, ".cmd", os + 8 ); else mu_cmd.set_self_2(NULL, NULL, 0);
  if (name) mu_sourceId.set_self_2(name, ".sourceId", os + 16 ); else mu_sourceId.set_self_2(NULL, NULL, 0);
  if (name) mu_offset.set_self_2(name, ".offset", os + 24 ); else mu_offset.set_self_2(NULL, NULL, 0);
  if (name) mu_mopCop.set_self_2(name, ".mopCop", os + 32 ); else mu_mopCop.set_self_2(NULL, NULL, 0);
  if (name) mu_s.set_self_2(name, ".s", os + 40 ); else mu_s.set_self_2(NULL, NULL, 0);
  if (name) mu_eh.set_self_2(name, ".eh", os + 48 ); else mu_eh.set_self_2(NULL, NULL, 0);
  if (name) mu_data.set_self_2(name, ".data", os + 56 ); else mu_data.set_self_2(NULL, NULL, 0);
  if (name) mu_newId.set_self_2(name, ".newId", os + 64 ); else mu_newId.set_self_2(NULL, NULL, 0);
  if (name) mu_memId.set_self_2(name, ".memId", os + 72 ); else mu_memId.set_self_2(NULL, NULL, 0);
}
...
void mu_1_ResPacket::set_self(const char *n, int os)
{
  ...
  if (name) mu_cn.set_self_2(name, ".cn", os + 8 ); else mu_cn.set_self_2(NULL, NULL, 0);
  if (name) mu_co.set_self_2(name, ".co", os + 16 ); else mu_co.set_self_2(NULL, NULL, 0);
  if (name) mu_mCState.set_self_2(name, ".mCState", os + 24 ); else mu_mCState.set_self_2(NULL, NULL, 0);
  if (name) mu_data.set_self_2(name, ".data", os + 32 ); else mu_data.set_self_2(NULL, NULL, 0);
  if (name) mu_forwId.set_self_2(name, ".forwId", os + 40 ); else mu_forwId.set_self_2(NULL, NULL, 0);
  if (name) mu_backId.set_self_2(name, ".backId", os + 48 ); else mu_backId.set_self_2(NULL, NULL, 0);
}
...
if (n) array[i].set_self_ar(n,"MemoryLineId_1", i * 24 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
void mu_1_CacheLine::set_self(const char *n, int os)
{
  ...
  if (name) mu_cState.set_self_2(name, ".cState", os + 0 ); else mu_cState.set_self_2(NULL, NULL, 0);
  if (name) mu_forwId.set_self_2(name, ".forwId", os + 8 ); else mu_forwId.set_self_2(NULL, NULL, 0);
  if (name) mu_backId.set_self_2(name, ".backId", os + 16 ); else mu_backId.set_self_2(NULL, NULL, 0);
  if (name) mu_memId.set_self_2(name, ".memId", os + 24 ); else mu_memId.set_self_2(NULL, NULL, 0);
  if (name) mu_addrOffset.set_self_2(name, ".addrOffset", os + 32 ); else mu_addrOffset.set_self_2(NULL, NULL, 0);
...
if (n) array[i].set_self_ar(n,"CacheLineId_1", i * 48 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
void mu_1_LB::set_self(const char *n, int os)
{
  ...
  if (name) mu_firstEntrySub.set_self_2(name, ".firstEntrySub", os + 16 ); else mu_firstEntrySub.set_self_2(NULL, NULL, 0);
  if (name) mu_memId.set_self_2(name, ".memId", os + 24 ); else mu_memId.set_self_2(NULL, NULL, 0);
  if (name) mu_addrOffset.set_self_2(name, ".addrOffset", os + 32 ); else mu_addrOffset.set_self_2(NULL, NULL, 0);
}
...
void mu_1_SubState::set_self(const char *n, int os)
{
  ...
  if (name) mu_lC.set_self_2(name, ".lC", os + 40 ); else mu_lC.set_self_2(NULL, NULL, 0);
}
...
void mu_1_L0::set_self(const char *n, int os)
{
  ...
  if (name) mu_mState.set_self_2(name, ".mState", os + 8 ); else mu_mState.set_self_2(NULL, NULL, 0);
  if (name) mu_co.set_self_2(name, ".co", os + 16 ); else mu_co.set_self_2(NULL, NULL, 0);
}
...
void mu_1_L1::set_self(const char *n, int os)
{
  ...
  if (name) mu_firstLoop.set_self_2(name, ".firstLoop", os + 8 ); else mu_firstLoop.set_self_2(NULL, NULL, 0);
  if (name) mu_cState.set_self_2(name, ".cState", os + 16 ); else mu_cState.set_self_2(NULL, NULL, 0);
}
...
void mu_1_L2::set_self(const char *n, int os)
{
  ...
  if (name) mu_firstLoop.set_self_2(name, ".firstLoop", os + 8 ); else mu_firstLoop.set_self_2(NULL, NULL, 0);
  if (name) mu_cState.set_self_2(name, ".cState", os + 16 ); else mu_cState.set_self_2(NULL, NULL, 0);
  if (name) mu_nextId.set_self_2(name, ".nextId", os + 24 ); else mu_nextId.set_self_2(NULL, NULL, 0);
}
...
void mu_1_ToState::set_self(const char *n, int os)
{
  ...
  if (name) mu_l1.set_self_2(name, ".l1", os + 24 ); else mu_l1.set_self_2(NULL, NULL, 0);
  if (name) mu_l2.set_self_2(name, ".l2", os + 48 ); else mu_l2.set_self_2(NULL, NULL, 0);
}
...
void mu_1_ExecState::set_self(const char *n, int os)
{
  ...
  if (name) mu_insPhase.set_self_2(name, ".insPhase", os + 32 ); else mu_insPhase.set_self_2(NULL, NULL, 0);
  if (name) mu_cTPtr.set_self_2(name, ".cTPtr", os + 64 ); else mu_cTPtr.set_self_2(NULL, NULL, 0);
  if (name) mu_tStat.set_self_2(name, ".tStat", os + 72 ); else mu_tStat.set_self_2(NULL, NULL, 0);
  if (name) mu_fetchOption.set_self_2(name, ".fetchOption", os + 104 ); else mu_fetchOption.set_self_2(NULL, NULL, 0);
  if (name) mu_data.set_self_2(name, ".data", os + 136 ); else mu_data.set_self_2(NULL, NULL, 0);
  if (name) mu_subState.set_self_2(name, ".subState", os + 144 ); else mu_subState.set_self_2(NULL, NULL, 0);
  if (name) mu_toState.set_self_2(name, ".toState", os + 192 ); else mu_toState.set_self_2(NULL, NULL, 0);
}
...
void mu_1_ExecUnit::set_self(const char *n, int os)
{
  ...
  if (name) mu_reqPacket.set_self_2(name, ".reqPacket", os + 272 ); else mu_reqPacket.set_self_2(NULL, NULL, 0);
  if (name) mu_resPacket.set_self_2(name, ".resPacket", os + 352 ); else mu_resPacket.set_self_2(NULL, NULL, 0);
}
...
void mu_1_Proc::set_self(const char *n, int os)
{
  ...
  if (name) mu_cache.set_self_2(name, ".cache", os + 408 ); else mu_cache.set_self_2(NULL, NULL, 0);
}
...
if (n) array[i].set_self_ar(n,"ProcId_1", i * 456 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"ProcId_2", i * 456 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"MemoryId_1", i * 24 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
/*** Variable declaration ***/
mu_1__type_2 mu_proc("proc",32);

/*** Variable declaration ***/
mu_1__type_3 mu_memory("memory",944);
...
/*** Variable declaration ***/
mu_1_NodeId mu_nextId("nextId",8);
...
/*** Variable declaration ***/
mu_1_MemoryCacheStates mu_temp("temp",16);
...
/*** Variable declaration ***/
mu_1_CacheLineId mu_c("c",56);

/*** Variable declaration ***/
mu_1_DataFlags mu_updates("updates",64);
...
/*** Variable declaration ***/
mu_1_DataFlags mu_updates("updates",56);

/*** Variable declaration ***/
mu_1_SStatValues mu_status("status",64);
